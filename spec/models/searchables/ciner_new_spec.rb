...
describe Searchables::CinerNew do
  subject(:searchable) { ciner_new }

  let(:ciner_new) { create(:ciner_new) }
  ...
  describe 'search methods' do
    ...
    describe '#search_link' do
      let(:expected_search_link) do
        searchable.url_helper.admin_ciner_news_index_path(ciner_new: searchable.id)
      end
