...
module Admin
  module CurriculumFunctionsBreadcrumb
    ...
    def index_breadcrumbs
      [
        area_breadcrumb,
        [CurriculumFunction.model_name.human(count: 2), ""]
      ]
    end
    ...
    def index_breadcrumb
      [CurriculumFunction.model_name.human(count: 2), admin_curriculum_functions_path]
    end
  end
end
